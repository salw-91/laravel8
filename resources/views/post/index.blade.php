                ...
                <div class="card" style="width: 18rem;">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            <p class="card-text">Created at: {{ $item->user->name }}</p>
                        </li>
                        <li class="list-group-item">
                            <p class="card-text">Created at: {{ $item->created_at->diffForhumans() }}</p>
                        </li>
                        <li class="list-group-item">
                            <p class="card-text">Updated at: {{ $item->updated_at->diffForhumans() }}</p>
                        </li>
                    </ul>
                    <div class="card-body">
