        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                        <div class="grid grid-cols-1 md:grid-cols-2">
                            <div class="p-6 flex items-center">
                                ...
                                <a href="{{ route('shop.index') }}" class="ml-1 underline shop">
                                    Shop
                                </a>
                            </div>
                            ...
                            <div class="p-6 flex items-center">
                                ...
                                <a href="{{ url('/home') }}" class="text-sm underline shop">Home</a>
                            @else
                                <a href="{{ route('login') }}" class="text-sm underline shop">Login</a>

                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="ml-4 text-sm underline shop">Register</a>
                                @endif
                @endif
            ...
            @auth
                <div class="p-6 flex items-center">
                    ...
                    <a href="{{ route('posts.index') }}" class="ml-1 underline shop">
                        <span style="font-size: 1em; color: rgb(255, 255, 255);">
